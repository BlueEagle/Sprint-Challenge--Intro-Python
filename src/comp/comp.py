...
print("Starts with D:")
a = [human.name for human in humans if human.name[0:1] == "D"]
print(a)

# Write a list comprehension that creates a list of names of everyone
# whose name ends in "e".
print("Ends with e:")
b = [human.name for human in humans if human.name[-1:len(human.name)] == "e"]
print(b)

# Write a list comprehension that creates a list of names of everyone
# whose name starts with any letter between 'C' and 'G' inclusive.
print("Starts between C and G, inclusive:")
c = [human.name for human in humans if ord(human.name[0:1])
...
h = [math.sqrt(float(human.age)) for human in humans]
print(h)
